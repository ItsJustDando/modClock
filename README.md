...
## Virtual Environment
On the Raspberry Pi Zero W, you will need to create a Virtual Environment to install dependencies for your project.
Full documentation in the `env_setup.md` file

Enter the env using `source env/bin/activate`. Move on to installing dependencies on the env.
